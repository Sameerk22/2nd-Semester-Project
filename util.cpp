...
//ADDITIOANL--function to make a diamond using 2 triangles
void DrawDiamond(int sx, int sy, int offset, float* color ){
	DrawTriangle(sx+offset, sy+offset/2, sx+offset/2, sy+offset, sx, sy+offset/2, color);
	DrawTriangle(sx+offset, sy+offset/2, sx+offset/2, sy, sx, sy+offset/2, color);
}
